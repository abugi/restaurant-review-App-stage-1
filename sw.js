...
const static = 'restReviewStatic-v42';
const dynamic = 'restReviewDynamic-v3';
const appShell = [
    '/',
    '/index.html','/fallback.html','/restaurant.html',
    '/manifest.json',
    '/css/mobile.css','/css/phablet.css','/css/styles.css','/css/tablet.css',
    '/js/idb.js','/js/indexDB.js','/js/zdbhelper.js','/js/main.js','/js/restaurant_info.js',
